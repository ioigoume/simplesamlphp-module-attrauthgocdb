...
if ( array_key_exists('yes', $_REQUEST) || array_key_exists('no', $_REQUEST) ) {
  ...
  // TODO:  this should be updated at the end. We should clean the session before leaving
...
$t = new SimpleSAML_XHTML_Template($globalConfig, 'attrauthgocdb:user_in_form_template.php');
