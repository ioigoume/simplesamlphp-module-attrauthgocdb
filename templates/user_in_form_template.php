...
//assert('is_array($this->data["attrauthgocdb"])');
...
//$this->data['head'] = '<link rel="stylesheet" type="text/css" href="/' . $this->data['baseurlpath'] . 'module.php/themeegi/resources/css/app.uncompressed.css" />' . "\n";
